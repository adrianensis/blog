...
En este post me ceñiré al concepto de que **"una empresa te contrate como Junior"**, ya que es lo que más <!--more--> me habéis transmitido en vuestras preguntas y mensajes. Por tanto queda fuera del scope de este post el caso de ser indie o emprender 🚀
...
Remember, en el blog tengo un [post]({{site.url}}{{site.baseurl}}/c++){:target="_blank"} sobre preguntas para entrevistas de C++ Gameplay Programmer 💬✅
